...
ip -6 addr add 2010:5a8:2e20:f2e::2/64 dev 6to4_To_IR
ip link set 6to4_To_IR mtu 1420
ip link set 6to4_To_IR up

ip -6 tunnel add GRE6Tun_To_IR mode ip6gre remote 2010:5a8:2e20:f2e::1 local 2010:5a8:2e20:f2e::2
ip addr add 121.113.9.2/30 dev GRE6Tun_To_IR
...
ip -6 addr add 2010:5a8:2e20:f2e::1/64 dev 6to4_To_KH
ip link set 6to4_To_KH mtu 1420
ip link set 6to4_To_KH up

ip -6 tunnel add GRE6Tun_To_KH mode ip6gre remote 2010:5a8:2e20:f2e::2 local 2010:5a8:2e20:f2e::1
ip addr add 121.113.9.1/30 dev GRE6Tun_To_KH
ip link set GRE6Tun_To_KH mtu 1420
ip link set GRE6Tun_To_KH up

sysctl net.ipv4.ip_forward=1
iptables -t nat -A PREROUTING -p tcp --dport 22 -j DNAT --to-destination 121.113.9.1
iptables -t nat -A PREROUTING -j DNAT --to-destination 121.113.9.2
...
case $server_choice in
    ...
    2)
        ...
        iptables -t nat -D PREROUTING -j DNAT --to-destination 121.113.9.2 2>/dev/null
